...
const filename = "actualpricemts.xlsx";
const filePath = 'C:\\Milamed request analyze\\actualpricemts.xlsx';
...
if (i != 0 ){return true; } else {return false;}
 ...
 downloadPdf();
  ...
  function downloadPdf() {
   let tokenlist = 'Basic TWVkVGVjaHxNZWRUZWNoV2ViOk1lZFRlY2gxMjMh'; 
...
const urlanal = 'http://195.211.240.20:11998/KDG_SIMPLE_LAB_API/MedTech/dictionary/analyzes';
const Packagelist = 'http://195.211.240.20:11998/KDG_SIMPLE_LAB_API/MedTech/dictionary/packages';
...
// тут кінець іфа
 ...
 workbook.xlsx.writeFile('C:\\Milamed request analyze\\actualpricemts.xlsx')
.then(function() {
